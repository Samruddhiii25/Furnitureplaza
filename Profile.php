...
{    
     ...
     $sql = "INSERT INTO Userdetails VALUES ('$user_name','$email','$gender','$address','$pincode','$phoneno')";
...
<div class="card" style="margin: 40px auto;">
            <div class="row">
                <div class="col-md-8 cart">
                    <div class="title">
                        <div class="row">
                            <div class="col"><h4><b>Profile</b></h4></div>
                    ...
                    <input type="textarea" name="address"  placeholder="Address" id="Address" >
                    <input type="text" name="pincode"  placeholder="Pincode" id="Pincode" >
                    <input type="text" name="phoneno"  placeholder="Phone Number" id="Phonenumber" >
                    ...
                    <button class="btn" type="submit" name="save" value="send" style="position:relative; top: 40%;">Save</button>
                </div>
            </div>
